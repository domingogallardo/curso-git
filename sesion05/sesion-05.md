...
<!-- 
Poner aquí la solución de hacer un merge de master en la rama
para los caso en los que ya se han publicado y descargado los commits
de la rama 
--->
...
<img style="margin-left:40px" src="imagenes/merge-squash.png" width="700px"/>
...
<!--
Lo siguiente está mal: sí que hay que intregrar el commit 
en master, para después poder integrar futuros hotfix de la
rama en master
-->
